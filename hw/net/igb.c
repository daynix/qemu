...
static const uint16_t igb_eeprom_template[] = {
  ...
  /*      PBA      |ICtrl1 | SSID  | SVID  | DevID |-------|ICtrl2 */
    0x1040, 0xffff, 0x046b, 0x484c, 0x108e, 0x10c9, 0x0000, 0x70c3,
  ...
  /* SwPin1| FunC  |LAN-PWR|ManHwC |ICtrl3 | IOVct |VDevID |-------*/
    0xe30c, 0x2020, 0x1ae5, 0x004a, 0x2080, 0x00f7, 0x10ca, 0x0000,
...
static const VMStateDescription igb_vmstate = {
    ...
    .fields = (VMStateField[]) {
        ...
        VMSTATE_UINT16_ARRAY(core.phy, IgbState, E1000E_PHY_PAGE_SIZE),
