...
static void igb_pci_start_hw(QOSGraphObject *obj)
{
    ...
    e1000e_macreg_write(&d->e1000e, E1000_TDLEN(0), IGB_RING_LEN);
    ...
    e1000e_macreg_write(&d->e1000e, E1000_RDLEN(0), IGB_RING_LEN);
...
static void *igb_pci_create(void *pci_bus, QGuestAllocator *alloc, void *addr)
{
    ...
    d->e1000e.tx_ring = guest_alloc(alloc, IGB_RING_LEN);
    g_assert(d->e1000e.tx_ring != 0);

    /* Allocate and setup RX ring */
    d->e1000e.rx_ring = guest_alloc(alloc, IGB_RING_LEN);
